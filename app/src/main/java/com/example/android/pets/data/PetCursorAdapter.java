...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        // Get the views to be populated with data in the Layout
        TextView nameView = view.findViewById(R.id.name);
        TextView summaryView = view.findViewById(R.id.summary);

        // Get data from the cursor and set it on the views gotten above as appropriate
        ...
        if (TextUtils.isEmpty(summary)) summaryView.setText("Unknown breed");
    }
}
